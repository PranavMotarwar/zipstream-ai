...
![**Figure 1.** Architecture of *zipstream-ai*, showing how compressed archives are streamed, parsed, and queried using LLMs through its core modules.](zipstream-ai modules.png){ width=80% }
